      ...
      child: ScaleTransition(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            boxShadow: [
              BoxShadow(
                  color: _gradA.withValues(alpha: 0.32),
                  blurRadius: 14,
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Future<void> fetchProfile() async {
    try {
      final response = await http
          .get(Uri.parse('$baseUrl/api/users/${widget.userId}'));
      if (response.statusCode == 200 && mounted) {
        final data = jsonDecode(response.body);
        setState(() => name = (data['name'] ?? '').toString());
      }
    } catch (_) {}
  }
  ...
  void _showSnackBar(String message, {bool success = true}) {
    ...
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      ...
      backgroundColor:
          success ? const Color.fromARGB(255, 56, 31, 67) : _red,
              ...
              actions: Row(
                  ...
                  children: [
                    TextButton(
                        ...
                        style: TextButton.styleFrom(foregroundColor: _inkMid),
  ...
  void _feedbackDialog() {
    ...
    showDialog(
        ...
        builder: (_) => _DialogShell(
              ...
              headerColor: _gradB,
              title: 'Send Feedback',
              subtitle: 'We read every message — thank you',
              body: _styledTextField(
                  controller: ctrl,
                  hint: 'Share your thoughts or suggestions…',
                  focusColor: _gradB,
                  maxLines: 5),
              actions: Row(
                  mainAxisAlignment: MainAxisAlignment.end,
                  children: [
                    TextButton(
                        onPressed: () => Navigator.pop(context),
                        style:
                            TextButton.styleFrom(foregroundColor: _inkMid),
                        child: const Text('Cancel',
                            style:
                                TextStyle(fontWeight: FontWeight.w600))),
                    const SizedBox(width: 8),
  ...
  void _helpAndSupport() {
    final faqs = <(String, String)>[
      ('How do I submit a complaint?',
          'Go to Complaints, choose a category, describe your issue, attach documents (optional), and submit.'),
      ('How do I track my complaint?',
          'Use the Track screen to monitor real-time status updates on your submissions.'),
      ('What do the statuses mean?',
          'Pending: awaiting review. In-Progress: being addressed. Resolved: closed.'),
      ('Can I update my personal info?',
          'Yes — tap "Edit Profile" in Account Settings to change your name.'),
      ('Who handles urgent issues?',
          'Contact the designated support email or your department administration.'),
    ];
    showDialog(
        context: context,
        builder: (_) => _DialogShell(
              headerIcon: Icons.help_outline_rounded,
              headerColor: _gradMid,
              title: 'Help & Support',
            ...
            children: [
              Row(children: [
                Container(
                  ...
                  height: 44,
                  decoration: BoxDecoration(
                    color: _gradA.withValues(alpha: 0.10),
                    borderRadius: BorderRadius.circular(13),
                  ),
                  child: const Icon(Icons.logout_rounded, color: _gradA, size: 20),
                ),
                const SizedBox(width: 14),
                const Text(
                  'Sign out?',
              ...
              const Text(
                ...
                style: TextStyle(fontSize: 13.5, color: _inkMid, height: 1.5),
              ),
                  ...
                  child: GestureDetector(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        boxShadow: [
                          BoxShadow(
                            color: _gradA.withValues(alpha: 0.30),
                            blurRadius: 12,
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Wrap(
                                ...
                                runSpacing: 6,
                                children: [
                                  _infoBadge(Icons.badge_outlined,
                                      'ID · ${widget.userId}'),
                                  _infoBadge(
                                      Icons.school_rounded, 'Student'),
                                  _infoBadgeGreen(
      ...
      Positioned(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
            ...
            color: _green,
            border:
                Border.all(color: const Color(0xFF6A1280), width: 2),
          ),
        ),
      ),
    ]);
  ...
  Widget _infoBadgeGreen(IconData icon, String label) => Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border:
              Border.all(color: _green.withValues(alpha: 0.55), width: 1),
        ),
        child: Row(mainAxisSize: MainAxisSize.min, children: [
  ...
  Widget _statCard(String value, String label, IconData icon, Color light,
      Color dark) {
    return Expanded(
      child: Container(
        padding:
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(20),
          border: Border.all(
              color: light.withValues(alpha: 0.15), width: 1.5),
          boxShadow: [
            BoxShadow(
        ...
        child: Column(children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              shape: BoxShape.circle,
              border: Border.all(
                  color: light.withValues(alpha: 0.22), width: 1.5),
            ),
  ...
  Widget _buildSettingsCard() {
    final tiles = [
      _TileData(
          ...
          label: 'Edit Profile',
          subtitle: 'Update your display name',
          gradColors: [_gradA, _gradMid],
          onTap: _editProfile),
      _TileData(
          icon: Icons.rate_review_outlined,
          label: 'Send Feedback',
          subtitle: 'Share your thoughts with us',
          gradColors: [_gradMid, _gradB],
          onTap: _feedbackDialog),
      _TileData(
          icon: Icons.help_outline_rounded,
          label: 'Help & Support',
          subtitle: 'FAQs and contact information',
          gradColors: [_gradB, const Color(0xFF00838F)],
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
              color: _gradA.withValues(alpha: 0.05),
              blurRadius: 24,
          ...
          return Column(children: [
            Material(
              ...
              child: InkWell(
                ...
                splashColor:
                    t.gradColors.first.withValues(alpha: 0.05),
                highlightColor:
                    t.gradColors.first.withValues(alpha: 0.03),
                child: Padding(
                  ...
                  child: Row(children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            t.gradColors.first.withValues(alpha: 0.12),
                            t.gradColors.last.withValues(alpha: 0.08)
                          ],
                          begin: Alignment.topLeft,
                          end: Alignment.bottomRight,
                        ),
                        borderRadius: BorderRadius.circular(13),
                        border: Border.all(
                            color: t.gradColors.first
                                .withValues(alpha: 0.18),
                            width: 1),
                      ),
                      child: Icon(t.icon,
                          color: t.gradColors.first, size: 20),
                    ),
  ...
  Widget _buildFooter() => Center(
        child: Column(children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: _gradA.withValues(alpha: 0.08),
              borderRadius: BorderRadius.circular(10),
              border: Border.all(
                  color: _gradA.withValues(alpha: 0.18), width: 1),
            ),
            child: const Icon(Icons.support_agent_rounded,
                size: 18, color: _gradA),
          ),
          Text(
          ...
          Text(
            ...
            style: TextStyle(
                fontSize: 10,
                color: _inkLight.withValues(alpha: 0.45),
                letterSpacing: 0.5),
          ),
        ]),
      );
            ...
            return GestureDetector(
              ...
              child: AnimatedContainer(
                ...
                child: Column(
                    ...
                    children: [
                      isActive
                          ? Icon(tab.activeIcon, size: 22, color: _gradA)
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  _gradA.withValues(alpha: 0.15),
                  _gradB.withValues(alpha: 0.15)
                ],
                begin: Alignment.topLeft,
                end: Alignment.bottomRight,
              ),
              ...
              border: Border.all(
                  color: _gradA.withValues(alpha: 0.25), width: 1),
            ),
            child: const Icon(Icons.question_mark_rounded,
                color: _gradA, size: 12),
          ),
          Expanded(
            child: Text(question,
                style: const TextStyle(
